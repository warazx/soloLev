...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double currentLatitude = GPSTracker.getLastLocation().getLatitude();
        double currentLongitude = GPSTracker.getLastLocation().getLatitude();

        LatLng myPos = new LatLng(currentLatitude, currentLongitude);
